      ...
      <main id="top">
        ...
        <section className="section container">
          ...
          <Reveal className="grid grid--3 grid--tall" delay={80}>
            <MediaImg src="/assets/agos-05.jpg" alt="Agos com vinis" className="cover" />
            <MediaImg src="/assets/agos-02.jpg" alt="Agos com vinil" className="cover" />
            <MediaImg src="/assets/agos-01.jpg" alt="Agos em cena" className="cover" />
          </Reveal>
        </section>
        ...
        <section className="section container">
          ...
          <Reveal className="grid grid--big" delay={80}>
            <MediaImg src="/assets/agos-06.jpg" alt="Agos no set" className="cover" />
            <MediaImg src="/assets/capa.jpg" alt="Capa" className="cover" />
          </Reveal>
          <Reveal className="grid grid--2 grid--mid" delay={120}>
            <MediaImg src="/assets/agos-ideia.jpg" alt="Agos ideia" className="cover" />
            <MediaImg src="/assets/agos-04.jpg" alt="Agos retrato" className="cover" />
          </Reveal>
          <Reveal delay={140}>
        ...
        <section className="section container">
          <Reveal>
            <p className="tag">{t.identity.tag}</p>
            <h2 className="h2">{t.identity.title}</h2>
          </Reveal>
          <Reveal className="split split--identity" delay={80}>
            <MediaImg src="/assets/amix-collection.jpg" alt="Coleção A Mix" className="cover cover--soft" />
            <div className="idlist">
              {t.identity.items.map((item) => (
                <div key={item.label} className="idlist__item">
                  <div className="idlist__label">{item.label}</div>
                  <div className="idlist__desc">{item.desc}</div>
                </div>
              ))}
            </div>
          </Reveal>
          <Reveal className="grid grid--3 grid--mid" delay={120}>
            <MediaImg src="/assets/cover-clubpenguin-space.jpg" alt="Capa A Mix" className="cover" />
            <MediaImg src="/assets/cover-clubpenguin-ufo.jpg" alt="Capa A Mix" className="cover" />
            <MediaImg src="/assets/agos-04.jpg" alt="Agos retrato" className="cover" />
          </Reveal>
        </section>
        ...
        <section className="section container">
          ...
          <Reveal className="cards" delay={80}>
            <article className="card">
              <MediaImg src="/assets/cover-marola.jpg" alt="Marola Mix" className="card__img" />
              <h3 className="card__title">{t.universe.marola.title}</h3>
              <p className="card__desc">{t.universe.marola.desc}</p>
            </article>
            <article className="card">
              <MediaImg src="/assets/cover-clubpenguin-ufo.jpg" alt="Club Penguin" className="card__img" />
              <h3 className="card__title">{t.universe.digital.title}</h3>
              <p className="card__desc">{t.universe.digital.desc}</p>
            </article>
            <article className="card">
              <MediaImg src="/assets/cover-carnaval.jpg" alt="Folia e Groove" className="card__img" />
        ...
        <section className="section container">
          <Reveal className="split split--center">
            ...
            <MediaImg src="/assets/agos-02.jpg" alt="Agos com vinil" className="cover cover--portrait" />
          </Reveal>
        </section>
        ...
        <section className="section container">
          <Reveal className="split split--center split--rev">
            <MediaImg src="/assets/fuso-poster.jpg" alt="Fuso" className="cover cover--portrait" />
            <div>
